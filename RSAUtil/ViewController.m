...
- (void)viewDidLoad {
	...
	NSString *pubkey = @"MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDDI2bvVLVYrb4B0raZgFP60VXY\ncvRmk9q56QiTmEm9HXlSPq1zyhyPQHGti5FokYJMzNcKm0bwL1q6ioJuD4EFI56D\na+70XdRz1CjQPQE3yXrXXVvOsmq9LsdxTFWsVBTehdCmrapKZVVx6PKl7myh0cfX\nQmyveT/eqyZK1gYjvQIDAQAB";
	NSString *privkey = @"";

	//NSString *originString = @"hello world!";
     NSString *originString = @"oM5XM7TujSOvTbN+nc4Ghq1wyLdf1n8WTWGS8y7a3YZ8zNU9UlIxQ37hqbBwhsjEZODd5m4tOjg4exzplJwSSaVcpLZM3W+abyKDnN5Pri9Grun1dW5ZfUV6QcPw9jrfNcK6hlnKTT4ZxuOvIyQrv6NAd12MEoq/HSLM7jTXsGA=";
//	for(int i=0; i<4; i++){
...
//	}
	...
	NSLog(@"\n\nEnctypted with public key: %@\n\n", encWithPubKey);
	// Demo: decrypt with private key
	decWithPrivKey = [RSA decryptString:originString privateKey:privkey];
...
//	NSLog(@"\n\n\n\n(PHP enc)Decrypted with private key: %@", decWithPrivKey);
//	
...
//	NSLog(@"\n\n\n\n(PHP enc)Decrypted with public key: %@", decWithPublicKey);
}
